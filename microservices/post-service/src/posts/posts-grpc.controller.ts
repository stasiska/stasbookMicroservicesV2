...
import { CommentPostDto, CreateMediaDto, CreatePostDto, GetPostByIdDto, GetPostByUserIdDto, LikePostDto, Media, PaginationDto, Post, Posts, PostServiceController } from '../interface/post_service';
