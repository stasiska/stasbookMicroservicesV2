...
import { AuthorIdDto, CreateGroupDto, EmptyRes, FollowDto, FollowRes, FriendDto, FriendRes, GroupActionDto, GroupList, GroupRes, SOCIAL_SERVICE_NAME, SOCIAL_SERVICE_PACKAGE_NAME, SocialServiceClient, UserIdReq, UserList } from "../interface/social_service";
