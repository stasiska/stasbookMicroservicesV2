...
import { AUTH_SERVICE_NAME, AuthServiceClient, Boolean, emailConfirmationDto, Empty, FindOneUserByIdDto, LoginDto, OauthCallbackDto, OauthCallbackRes, oauthConnectRes, passwordDto, providerDto, RegistrationDto, resetPasswordDto, User, USER_SERVICE_PACKAGE_NAME } from "../auth2/types/auth_service";
