...
import { CommentPostDto, CreateMediaDto, CreatePostDto, GetPostByIdDto, GetPostByUserIdDto, LikePostDto, Media, PaginationDto, Post, POST_SERVICE_NAME, POST_SERVICE_PACKAGE_NAME, Posts, PostServiceClient } from "../post/types/post_service";
